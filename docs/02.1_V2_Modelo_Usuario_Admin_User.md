...
# /api/v#/admin-user/ (GET y POST)
# /api/v#/admin-user/ID/ (GET, PUT, PATCH, DELETE)
...
# Registramos la vista bajo el subfijo 'users'
...
| :--- | :--- | :--- | :--- | :--- |
| **Registrar** | `POST` | `/api/v1/master/users/` | ` {
...
| **Listar** | `GET` | `/api/v1/master/users/` | (Enviar vacío) | `200 OK` (Lista de objetos) |
| **Ver Uno** | `GET` | `/api/v1/master/users/1/` | (Enviar vacío) | `200 OK` (Objeto único) |
| **Editar** | `PATCH` | `/api/v1/master/users/1/` | `{"cargo_interno": "Administrador"}` | `200 OK` |
| **Borrar** | `DELETE` | `/api/v1/master/users/1/` | (Enviar vacío) | `204 No Content` |
...
1. Abra una nueva pestaña en Postman para una petición `GET` a `/api/v1/master/users/`.
...
1. **URL y Método:** (Ej: `GET /api/v1/master/users/`).
