...
class TenantPermission(models.Model):
    ...
    codename = models.CharField(
        max_length=100, unique=True, verbose_name="Código Interno"
    )
...
class TenantRol(models.Model):
    ...
    permission = models.ManyToManyField(
        TenantPermission, blank=True, verbose_name="Permisos Asignados"
    )
...
class TenantUser(AbstractBaseUser):
    ...
    middle_name = models.CharField(
        max_length=50, blank=True, null=True, verbose_name="Segundo Nombre"
    )
    last_name = models.CharField(max_length=50, verbose_name="Primer Apellido")
    second_last_name = models.CharField(
        max_length=50, blank=True, null=True, verbose_name="Segundo Apellido"
    )
